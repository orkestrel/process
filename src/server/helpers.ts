 ...
 *
 * @remarks
 * Windows ends the tree through {@link killTree}, falling back to a direct kill after the utility
 * fails, because the host has no cooperative termination to offer. A POSIX host signals the
